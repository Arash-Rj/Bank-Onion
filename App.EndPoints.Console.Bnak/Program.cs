...
CardAppService cardService = new CardAppService();
TransactionAppService trasactionService = new TransactionAppService();
        ...
        switch (res)
        {
            case 1:
                ...
                do
                {
                    ...
                    Codes[randomcode] = DateTime.Now.AddSeconds(20);
                    Console.ForegroundColor = ConsoleColor.Red;
